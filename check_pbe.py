...
game = Game(env)
tree_ind = 7
table, avg_diff_on, avg_diff_off, max_diff, v_loss_on, v_loss_off, v_based_avg_diff_on, v_based_avg_diff_off = game.draw_game_tree(model, rating, False, tree_ind, ",5.1-4,7,13,", tree_path=path + "/tree-" + str(tree_ind) + ".svg")#335,249,284
